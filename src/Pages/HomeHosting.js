    ...
    return (
      <div className="body_wrapper">
        ...
        <HostingAction
          ...
          Atext="用友專注於企業管理軟件與服務領域，為亞太地區提供ERP軟件、集團管理軟件、人力資源管理軟件、財務會計管理軟件、供應鏈管理軟件、客戶關係管理軟件、辦公室自動化服務，支撐了亞太區眾多不同規模企業的信息化建設，推動了企業的管理進步。現在，用友亦為企業提供雲計算、平台、應用、數據、業務、知識、信息服務多態融合的2.0版智能化企業雲服務，致力於推動企業和公共組織互聯網化、金融化創新發展，服務企業IT產業轉型升級。"
        />
